...
class Timer(object):
    ...
    def __init__(self,
        ...
        Input:
            template: (optional) a template string that can be used to format the timer. Inside the string, use {0} to
            denote the hour, {1} to denote the minute, and {2} to denote the seconds. Default '{0}h{1}m{2:.2f}s'
        """
    ...
    def lap(self,
        ...
        Input:
            use_template: (optional) if True, returns the time as a formatted string. Otherwise, return the real-valued
            time. Default True.
        """
