"""
This implements some dummy functions that mimics the MPI behavior when the size is 1. It is here solely to provide
(provably limited) ability to run single noded tasks when one cannot install mpi or mpi4py.
"""
